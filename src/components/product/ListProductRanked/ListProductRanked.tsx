import { ComponentStyle as S } from './ListProductRanked.styled';
...
interface ListProductRankedProps {
  productId: string | undefined;
  rank: number;
}

const ListProductRanked = ({ productId, rank }: ListProductRankedProps) => {
  /**
   * 기본 상품 리스트입니다.
...
export default ListProductRanked;
